...
codes = 'PRUEBA-01,tkd12,jc dsjv,UI-DEL-1,CLI-TEST,UI-DEL-VERIFY-1781137665110'
encoded_codes = urllib.parse.quote(codes, safe='(),')
req = urllib.request.Request(
    f'{SUPABASE_URL}/rest/v1/products?codigo=in.({encoded_codes})',
    headers={
        'apikey': ANON_KEY,
